...
- 📋 **Список процессов** - просмотр активных процессов на удаленных компьютерах
- 🌐 **Кроссплатформенность** - поддержка Windows и Linux
- 📱 **Адаптивный дизайн** - работает на всех устройствах

## 🛠 Требования

- **Go 1.18+** с поддержкой выполнения системных команд
- **Веб-сервер** может запускаться как standalone приложение на любом порту
...
- **Windows**: Настроенные права для удаленного выполнения PowerShell команд через WinRM
- **Linux**: Настроенный SSH доступ с правами root или пользователем с доступом к `/proc`
- **Сетевые права** для выполнения команд на удаленных компьютерах
...
5. **Просмотр процессов:**
   - Нажмите кнопку "📋 Процессы" рядом с любым онлайн компьютером
   - Откроется модальное окно со списком активных процессов
   - Для Windows: отображаются PID, имя процесса, полный путь, пользователь, статус
   - Для Linux: отображаются PID, имя процесса, загрузка CPU и памяти, пользователь, статус
